...
**Примечание:** Проект активно развивается. Баги возможны и неизбежны. Если что-то сломалось, проверьте консоль браузера и сообщите об ошибке с деталями, я постараюсь исправить баги.
